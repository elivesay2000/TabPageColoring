...
namespace TabPageColoring
{
   public partial class Form1 : Form
   {
      ...
      public Form1()
      {
         ...
         TabColors.Add(0, defaultColor);
         TabColors.Add(1, defaultColor);
         TabColors.Add(2, defaultColor);
      }
      ...
      private void tabControl1_DrawItem(object sender, DrawItemEventArgs e)
      {
         ...
         using (Brush br = new SolidBrush(TabColors[e.Index]))
         {
            ...
            SizeF sz =  e.Graphics.MeasureString(tbc_Bottom.TabPages[e.Index].Text, e.Font);
                        e.Graphics.DrawString   (tbc_Bottom.TabPages[e.Index].Text, e.Font, Brushes.Black, e.Bounds.Left + (e.Bounds.Width - sz.Width) / 2, e.Bounds.Top + (e.Bounds.Height - sz.Height) / 2 + 1);
